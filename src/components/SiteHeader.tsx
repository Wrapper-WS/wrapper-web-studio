...
export function SiteHeader() {
  ...
  return (
    <header style={{ position: 'fixed', top: 0, left: 0, right: 0, zIndex: 100, padding: '12px 16px' }}>
      <div
        className="glass-nav"
        style={{
          ...
          <div style={{
            ...
            <img
              ...
              onError={(e) => {
                ...
                if (p) p.innerHTML = '<span style="color:#fff;font-family:Space Grotesk,sans-serif;font-weight:700;font-size:16px">W</span>'
              }}
            />
          </div>
          <span style={{
