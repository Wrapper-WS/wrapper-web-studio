    ...
    <main style={{ paddingTop: 96 }}>
      ...
      >
        ...
        <div style={{
          ...
          background: 'radial-gradient(circle, rgba(0,217,188,0.08) 0%, rgba(165,104,234,0.055) 50%, transparent 70%)',
          pointerEvents: 'none',
        }} />
        ...
        <div style={{ position: 'relative', maxWidth: 640, margin: '0 auto', width: '100%' }}>
          ...
          <div
            ...
            onMouseEnter={(e) => {
              ...
              e.currentTarget.style.boxShadow = '0 28px 70px -16px rgba(0,217,188,0.12)'
            }}
            onMouseLeave={(e) => {
              e.currentTarget.style.transform = 'translateY(0)'
              e.currentTarget.style.boxShadow = '0 24px 60px -20px rgba(0,0,0,0.5)'
            }}
          >
            <h1 style={{
      ...
      {/* Why section — clear breathing room from hero */}
      <section style={{ padding: '56px 16px 64px', maxWidth: 1100, margin: '0 auto' }}>
            ...
            <RevealCard key={i} delay={i * 80}>
              <div
                ...
                onMouseEnter={(e) => {
                  ...
                  e.currentTarget.style.boxShadow = item.accent === 'teal'
                    ? '0 16px 40px rgba(0,217,188,0.12)' : '0 16px 40px rgba(165,104,234,0.12)'
                  e.currentTarget.style.borderColor = item.accent === 'teal'
                    ? 'rgba(0,217,188,0.22)' : 'rgba(165,104,234,0.22)'
                }}
                onMouseLeave={(e) => {
                  e.currentTarget.style.transform = 'translateY(0)'
              ...
              >
                <div style={{
                  ...
                  border: `1px solid ${item.accent === 'teal' ? 'rgba(0,217,188,0.3)' : 'rgba(165,104,234,0.3)'}`,
      ...
      <section style={{ padding: '0 16px 80px', maxWidth: 1100, margin: '0 auto' }}>
        <RevealCard>
          <div
            style={{
              background: 'linear-gradient(135deg, rgba(0,217,188,0.09), rgba(165,104,234,0.09))',
              border: '1px solid var(--border-strong)',
              borderRadius: 24,
            ...
            onMouseEnter={(e) => {
              e.currentTarget.style.transform = 'translateY(-2px)'
              e.currentTarget.style.boxShadow = '0 24px 64px rgba(0,217,188,0.1)'
            }}
            onMouseLeave={(e) => {
              e.currentTarget.style.transform = 'translateY(0)'
              e.currentTarget.style.boxShadow = 'none'
